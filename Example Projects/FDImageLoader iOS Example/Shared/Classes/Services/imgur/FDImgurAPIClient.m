...
static FDImgurAPIClient *_sharedInstance;


#pragma mark - Class Definition

@implementation FDImgurAPIClient
{
...
+ (void)initialize
{
	...
	{
		_sharedInstance = [[FDImgurAPIClient alloc] 
			init];
...
+ (FDImgurAPIClient *)sharedInstance
{
